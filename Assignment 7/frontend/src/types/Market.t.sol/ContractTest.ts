...
export interface ContractTestInterface extends utils.Interface {
  functions: {
    ...
    "testBurnFailOnUninitialized(uint256)": FunctionFragment;
    "testInitialize(uint256,uint256)": FunctionFragment;
    "testInitialize1()": FunctionFragment;
    "testMintFailOnUninitialized()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testBurnFailOnUninitialized"
      | "testInitialize"
      | "testInitialize1"
      | "testMintFailOnUninitialized"
      | "tip"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testBurnFailOnUninitialized",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testInitialize1",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testMintFailOnUninitialized",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ContractTest extends BaseContract {
  ...
  callStatic: {
    ...
    testInitialize1(overrides?: CallOverrides): Promise<void>;

    testMintFailOnUninitialized(overrides?: CallOverrides): Promise<void>;
