...
export interface MintedStateTestInterface extends utils.Interface {
  functions: {
    ...
    "testSellX()": FunctionFragment;
    "testSellY()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "testSellX", values?: undefined): string;
  encodeFunctionData(functionFragment: "testSellY", values?: undefined): string;
  encodeFunctionData(
...
export interface MintedStateTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintedStateTestInterface;
  ...
  callStatic: {
    ...
    testSellX(overrides?: CallOverrides): Promise<void>;

    testSellY(overrides?: CallOverrides): Promise<void>;
